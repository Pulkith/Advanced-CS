...
//			buttonBar = new JPanel(new GridLayout(2, 2)); // combined layout of buttons
//			// and text
//
...
//			if (mazeLoaded) {
//				if(!maze.isSolvable && !maze.solved) {
//					makeNewSolver();
//					this.solver.solve();
//					this.solver.setInitialSolveState();
//				}
//				solveButton();
//			}
//		}
...
//
//	/**
//	 * Hlandles the user clicking on the solver type button.
//	 */
...
//		solver = new MazeSolverStack(this.maze, this.paintGrid);
//	}
//
//	/**
...
//		JFileChooser chooser = new JFileChooser(new File("../CS3/src/MazeSolver"));
...
//			solveButton.setBackground(Color.green);
//			mazeLoaded=true;
//			paintGrid = new MazeViewCell[maze.getRowLen()][maze.getColLen()];
//			this.initiateMazeView();
//			timer.stop();
//			reset();
//		}
//	}
...
//			//this.mazeDisplay.updateView(this.maze);
//			// update the path
...
//		}
//	}
//	private void initiateMazeView() {
//		if(mazeLoaded) {
//			mazeDisplay.removeAll();
//			mazeDisplay.setLayout(new GridBagLayout());
//			mazeDisplay.setBackground(Color.LIGHT_GRAY);
//			GridBagConstraints gbc = new GridBagConstraints();
//			gbc.ipadx = 20;
//			gbc.ipady = 20;
//			for(int i = 0; i < this.maze.getRowLen(); ++i) {
//				gbc.fill = GridBagConstraints.HORIZONTAL;
//				for (int j = 0; j < this.maze.getColLen(); ++j) {
//					MazeViewCell mvc = new MazeViewCell(this.maze.getCell(i, j));
//					paintGrid[i][j] = mvc;
//					mvc.updateView(this.maze.getCell(i, j));
//					gbc.gridx = i;
//					gbc.gridy = j;
//					this.mazeDisplay.add(mvc, gbc);
//				}
//			}
//
//			gbc.gridwidth = this.maze.getColLen();
//			mazeDisplay.revalidate();
//			mazeDisplay.repaint();
//			mazeDisplay.setVisible(true);
//		}
//	}
//	private void updateColor(Square c) {
//		paintGrid[c.getCol()][c.getRow()].updateView(c);
//	}
//
